...
if(isset($_POST['submit']))
{
   ...
   //$department=$_SESSION["department"];
    $query = "INSERT INTO dep (`equipment`) VALUES ('$equipment')";
    $query_run = mysqli_query($connection, $query);

    if($query_run)
    {
        echo '<script> alert("Data Saved"); </script>';
        header('Location: equipmentsadmin.php');
    }
    else
    {
...
if(isset($_POST['deletedata']))
{
    ...
    $query = "DELETE FROM dep WHERE id='$id'";
    $query_run = mysqli_query($connection, $query);
	...
	if(isset($_POST['updatedata']))
			{   
				$id = $_POST['update_id'];
				$equipment = $_POST['equipment'];
				$query = "UPDATE dep SET equipment	='$equipment' WHERE id='$id'  ";
				$query_run = mysqli_query($connection, $query);
    ...
    <div class="content-wrapper">
      ...
      <div class="card">
			...
			<div class="card-footer clearfix">
               	   	    <button class="btn btn-secondary book float-right"type="submit" name="submit" value = "Submit"> + Add Equipment</button>              </div>
        </div>
        ...
        <form action="" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="equipment" id="equipment" class="form-control" placeholder="equipment">
                </div>
            </div>
            <div class="modal-footer">

...
if(isset($_POST['submit']))
{
   ...
   //$department=$_SESSION["department"];
    $query = "INSERT INTO room (`RoomName`) VALUES ('$room')";
...
if(isset($_POST['deletedata']))
{
	...
	if(isset($_POST['updatedata']))
			{   
				$id = $_POST['update_id'];
				$room = $_POST['room'];
				$query = "UPDATE room SET RoomName	='$room' WHERE id='$id'  ";
				$query_run = mysqli_query($connection, $query);
    ...
    <div class="content-wrapper">
      ...
      <div class="card">
			...
			<div class="card-footer clearfix">
               	   	    <button class="btn btn-secondary book float-right"type="submit" name="submit" value = "Submit"> + Add Room</button>              </div>
        </div>

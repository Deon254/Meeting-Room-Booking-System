                                            ...
                                            <div class="col-lg-10" align="center">
                                                <div class="card" align="center">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="updatecode.php" method="post" enctype="multipart/form-data" class="form-horizontal">
...
?>   
																	...
																	<label for="select" class=" form-control-label">Equipment</label>
																	  ...
																	  <form action ="updatecode.php" method="post" id="framework_form">
...
?>   
																	...
																	<div class="row form-group">
                                                                    <div class="col col-md-3">
																	<label for="select" class=" form-control-label">Food and Drinks</label>
																	</div>
																	  <form action ="updatecode.php" method="post" id="framework_form">
    ...
    $food = [];
?>
<select id="food" name="food[]" multiple class="form-control">
	 <?php
    while($row = mysqli_fetch_array($result))
    {

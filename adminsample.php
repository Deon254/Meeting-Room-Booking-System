...
if(isset($_POST['submit']))
{
   ...
   //$department=$_SESSION["department"];
    $query = "INSERT INTO department (`DeptName`) VALUES ('$department')";
...
if(isset($_POST['updatedata']))
    {   
        $id = $_POST['update_id'];
        $department = $_POST['department'];
        $query = "UPDATE department SET DeptName='$department' WHERE id='$id'  ";
        $query_run = mysqli_query($connection, $query);
    ...
    <div class="content-wrapper">
      ...
      <div class="card">
			...
			<div class="card-footer clearfix">
               	   	    <button class="btn btn-secondary book float-right"type="submit" name="submit" value = "Submit"> + Add department</button>              </div>
        </div>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
      <script>
          $(".book").click(function(){
              var department=$(this).attr('data-timeslot');
              $("#myModal").modal("show");
          })
      </script>
